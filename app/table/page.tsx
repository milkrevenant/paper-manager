...
const demoPapers: Paper[] = [
  {
    ...
    lastAnalyzedAt: '2024-01-18T00:00:00.000Z',
  },
  {
    id: 'demo-2',
    folderId: 'folder-1',
    ...
    keywords: 'Attention, Transformer, Survey',
    purposes: ['Transformer 아키텍처 분석'],
    isQualitative: true,
    ...
    varsOthers: [],
    quantTechniques: [],
    results: ['Attention 메커니즘이 다양한 도메인에서 효과적임'],
    limitations: ['최신 연구 미포함'],
    implications: [],
    futurePlans: [],
    pdfPath: '',
    pdfFilename: '',
    userNotes: '좋은 논문',
    tags: ['Survey', 'Transformer'],
    isRead: false,
    importance: 4,
  ...
  },
  {
    ...
    folderId: 'folder-2',
    paperNumber: 3,
    title: 'Reinforcement Learning in Robotics: Applications and Challenges',
    author: 'Park, M.',
    year: 2024,
    publisher: 'Springer',
    subject: 'Robotics',
    keywords: 'Reinforcement Learning, Robotics, Control',
    purposes: ['로봇 제어 성능 향상', '실제 환경 적용 연구'],
    isQualitative: false,
    isQuantitative: true,
    qualTools: [],
    varsIndependent: ['학습 알고리즘', '환경 복잡도'],
    varsDependent: ['성공률', '학습 시간'],
    varsModerator: ['노이즈 수준'],
    varsMediator: [],
    varsOthers: [],
    quantTechniques: ['실험 연구', '시뮬레이션'],
    results: ['PPO 알고리즘이 실제 환경에서 안정적인 성능 달성'],
    limitations: ['하드웨어 제약'],
    implications: ['산업용 로봇 적용 가능성'],
    futurePlans: ['실제 환경 테스트 확대'],
    pdfPath: '',
    pdfFilename: '',
    userNotes: '',
    tags: ['RL', 'Robotics'],
  ...
  },
  {
    ...
    keywords: 'GNN, Social Network, Graph',
    purposes: ['소셜 네트워크 패턴 분석'],
    isQualitative: true,
    isQuantitative: true,
    qualTools: ['인터뷰', '사례 연구'],
    varsIndependent: ['네트워크 크기', '노드 특성'],
    varsDependent: ['분류 정확도'],
    varsModerator: [],
    varsMediator: [],
    varsOthers: [],
    quantTechniques: ['분류', '클러스터링'],
    results: ['GNN이 기존 방법보다 20% 높은 정확도'],
    limitations: [],
    implications: [],
    futurePlans: [],
    pdfPath: '',
  ...
  },
  {
    ...
    subject: 'AI Ethics',
    keywords: 'Ethics, AI, Policy',
    purposes: ['AI 윤리 가이드라인 제시'],
    isQualitative: true,
    isQuantitative: false,
    qualTools: ['문헌 분석', '전문가 인터뷰'],
    varsIndependent: [],
    varsDependent: [],
    varsModerator: [],
    varsMediator: [],
    varsOthers: [],
    quantTechniques: [],
    results: ['윤리적 AI 개발을 위한 5가지 원칙 제안'],
    limitations: ['문화적 차이 미고려'],
    implications: ['정책 수립에 기여'],
    futurePlans: ['다양한 문화권 연구'],
    pdfPath: '',
    pdfFilename: '',
    userNotes: '중요한 참고자료',
    tags: ['Ethics', 'Policy'],
...
export default function TablePage() {
  ...
  // Use Firestore papers if available, otherwise use demo data
  const papers = firestorePapers.length > 0 ? firestorePapers : demoPapers;
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="border-t border-stone-200 px-4 py-3 bg-stone-50 flex items-center justify-between text-sm text-stone-500">
                ...
                {firestorePapers.length === 0 && (
                  <span className="text-amber-600 text-xs">데모 데이터 표시 중</span>
                )}
              </div>
            </>
          )}
